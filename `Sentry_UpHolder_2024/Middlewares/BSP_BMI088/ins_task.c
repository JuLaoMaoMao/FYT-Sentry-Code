...
void INS_Task(void)
{
    ...
    // ins update
        ...
        INS.Gyro[1] = BMI088.Gyro[1];
		    if(BMI088.Gyro[2]>0.008f || BMI088.Gyro[2]<-0.008f)
        ...
        INS.atanxz = -atan2f(INS.Accel[0], INS.Accel[2]) * 180.0f / PI;
        INS.atanyz = atan2f(INS.Accel[1], INS.Accel[2]) * 180.0f / PI;
        ...
        INS.Yaw = QEKF_INS.Yaw;
				CircleContinue(&mc_imu_yaw, (INS.Yaw + 180.0f)*10.0f, 1800);
        INS.Pitch = QEKF_INS.Pitch;
				CircleContinue(&mc_imu_pitch, (INS.Pitch + 180.0f)*10.0f, 1800);
        INS.Roll = QEKF_INS.Roll;
        INS.YawTotalAngle = QEKF_INS.YawTotalAngle;
				yaw_angle = mc_imu_yaw.Angle + mc_imu_yaw.Circle * 3600;
				pitch_angle = mc_imu_pitch.Angle + mc_imu_pitch.Circle * 3600;
